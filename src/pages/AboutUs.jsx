    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <p className="text-lg text-gray-700 mb-6 leading-relaxed">
          Welcome to my ReactJS + Firebase Shopping App! I’re here to give you a smooth and safe online shopping experience. Whether you’re on your phone or desktop, our app is built to handle all your shopping needs easy and fast.
        </p>
