...
// Import shop logo
import logoImage from '../assets/sketch-logo-transparent-darkish-logo-for-better-visibility.png';
  ...
  const receiptHtml = `
    <div class="receipt-container">
      ...
      <div class="receipt-header">
        <div class="store-info">
          <div style="display: flex; align-items: center; gap: 8px;">
            <img src="${logoImage}" alt="Sketch Logo" style="width: 40px; height: 40px;" />
            <h1 style="font-size: 24px; margin: 0; transform: translateY(-2px);">Sketch</h1>
          </div>
          <p>Surat,Gujarat, India</p>
          <p>please.help.me@Sketch.nsl</p>
      ...
      <div style="margin-top: 20px; text-align: center; border-top: 1px dashed #d1d5db; padding-top: 15px;">
        ...
        <p style="color: #6b7280; font-size: 14px;">We appreciate your business and hope you enjoy your Sketchproducts.</p>
      </div>
    </div>
  `;
...
export const downloadOrderReceipt = async (order) => {
  try {
    ...
    await generatePdfFromElement('temp-receipt-container', `Sketch-Receipt-${order.orderId}`);
