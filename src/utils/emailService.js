...
const sendViaApiEndpoint = async (emailData) => {
  try {
    ...
    const formattedFrom = fromEmail.includes('<') ? fromEmail : `Sketch <${fromEmail}>`;
...
const sendOrderConfirmationEmail = async (order, user) => {
  ...
  try {
    ...
    const emailData = {
      to: user.email,
      subject: `Sketch - Order Confirmation #${order.orderId}`,
      body: emailBody,
    };
              ...
              <tr>
                <td style="padding: 26px 32px 16px 32px; background-color: #ffffff;" bgcolor="#ffffff">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td align="left">
                        <h1 style="margin: 0; font-size: 28px; font-weight: 700; color: #121212; letter-spacing: -0.5px;">Sketch</h1>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td style="padding: 48px 24px 48px 24px; background-color: #fff8f0; border-radius: 12px; text-align: center;" class="animated-scale">
                        ...
                        <p style="margin: 16px 0 24px; color: rgba(18, 18, 18, 0.8); font-size: 16px; line-height: 1.5;">Sketch will commence work on this immediately. You'll receive an email notification once it's shipped.</p>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td style="padding: 50px 40px 50px 40px; background-color: #1d1b2d; text-align: center; background-image: url('https://cloudfilesdm.com/postcards/image-1702463485006.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                  <p style="margin: 0 0 10px; font-size: 14px; color: rgba(255, 255, 255, 0.8); line-height: 1.3;">
                    © ${new Date().getFullYear()} Sketch. All Rights Reserved.<br>
          ...
          <tr>
            <td style="padding: 30px 30px; background-color: #38BDF8; text-align: center; border-radius: 8px 8px 0 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td align="center">
                    <h1 style="margin: 0; font-size: 28px; font-weight: 700; color: #ffffff; letter-spacing: -0.5px;">Sketch</h1>
          ...
          <tr>
            <td style="padding: 30px; background-color: #F1F5F9; text-align: center; border-radius: 0 0 8px 8px;">
              <p style="margin: 0; font-size: 14px; color: #64748B; font-weight: 500;">
                Thank you for shopping with Sketch
              </p>
