...
import { useSafeInView } from '../hooks/useWindowSize';
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <m.div variants={itemVariants} className="text-center md:text-left">
            ...
            >
              <p className="text-sm">
                DISCLAIMER: This website is not a commercial enterprise. Sketch is a fictitious entity created solely for educational and skill development purposes. No real products are sold, and no actual transactions occur herein. Any resemblance to real businesses, products, or services is purely coincidental.
              </p>
        ...
        >
          <p>© {new Date().getFullYear()} Sketch. No rights reserved.</p>
          <m.div 
            className="mt-4 text-sm"
            variants={itemVariants}
          >
            <span>Made by sahil shaikh</span>
            <m.span
              animate={{
                scale: [1, 1.2, 1],
